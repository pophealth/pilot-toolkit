...
class PophealthSummaryPanel < JPanel
  ...
  def update_analysis_results (analysis_results)
    ...
    @immunizations_present.set_percentage(analysis_results["immunizations_present"].to_f           / analysis_results["number_files"].to_f)
    @immunizations_coded.set_percentage(analysis_results["immunizations_coded"].to_f               / analysis_results["number_files"].to_f)
    @immunizations_mu_compliant.set_percentage(analysis_results["immunizations_mu_compliant"].to_f / analysis_results["number_files"].to_f)
